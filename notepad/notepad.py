...
root.wm_iconbitmap("5.ico")# Add the path to your .ico file here
...
def about():
    showinfo("About Notepad", "This is a simple notepad built with Tkinter. Enjoy note taking! ")#Here we should add a little documentation
